...
public class Jeux {
    ...
    private List<CategorieJeux> categories = new ArrayList<>();
...
public Jeux( String libelle, String ref,List<CategorieJeux> categories, LocalDateTime dateCreation,String imageJeux,String logoJeux,float note,float noteMyonne,float totalNote,int noteCount,int views ) {
 ...
 public List<CategorieJeux> getCategories() {
    ...
    // Setter method
    public void setCategories(List<CategorieJeux> categories) {
        this.categories = categories;
    }
