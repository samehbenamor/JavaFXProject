...
public class ServicesCommentaire {
    ...
    public void ajouterCommentaire(Commentaire c, int blogId) {
        try {
            ...
            ps.setObject(2, Date.from(c.getDate_creation().atZone(ZoneId.systemDefault()).toInstant()));
            ps.setObject(3, Date.from(c.getDate_modification().atZone(ZoneId.systemDefault()).toInstant()));
            ps.setInt(4, blogId);
    ...
    public void updateCommentaire(Commentaire c) {
        try {
            ...
            ps.setString(1, c.getContenu());
          ps.setObject(2, Date.from(c.getDate_modification().atZone(ZoneId.systemDefault()).toInstant()));
